...
_ERROR_CODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ERROR_BADREQEUST', index=13, number=100100,
      options=None,
      type=None),
  ],
  containing_type=None,
