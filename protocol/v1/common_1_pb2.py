...
_ERROR_CODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ERROR_ALREADY_FEEDBACK', index=21, number=100020,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ERROR_BAD_REQEUST', index=22, number=100100,
      options=None,
      type=None),
  ],
  containing_type=None,
